// Intv_Multimap implementation -*- C++ -*-
...
/** @file intv_multimap.hpp
 *  This is an internal header file, included by other library headers.
 *  You should not attempt to use it directly.
 */

#ifndef __INTV_MULTIMAP_HPP
#define __INTV_MULTIMAP_HPP 1
...
inline bool operator==(const intv_multimap<_Key, _Tp, _Compare, _Alloc> &__x,
                       const intv_multimap<_Key, _Tp, _Compare, _Alloc> &__y);
 ...
 *  intv_multimap can have multiple duplicate keys.
*/
template <class _Key, class _Tp, class _Compare, class _Alloc>
class intv_multimap {
...
public:
  ...
  class value_compare : public binary_function<value_type, value_type, bool> {
    friend class intv_multimap<_Key, _Tp, _Compare, _Alloc>;
...
private:
  typedef _Pst_tree<key_type, value_type, _Select1st<value_type>, key_compare,
                    _Alloc>
      _Rep_type;
  _Rep_type _M_t; // red-black tree representing intv_multimap
public:
  ...
  intv_multimap() : _M_t(_Compare(), allocator_type()) {}
  explicit intv_multimap(const _Compare &__comp,
                         const allocator_type &__a = allocator_type())
      : _M_t(__comp, __a) {}

  template <class _InputIterator, class _InputIterator2>
  intv_multimap(_InputIterator __first, _InputIterator __last,
                _InputIterator2 __first2)
      : _M_t(_Compare(), allocator_type()) {
    _M_t.insert_equal(__first, __last, __first2);
  }
  ...
  intv_multimap(const intv_multimap<_Key, _Tp, _Compare, _Alloc> &__x)
      : _M_t(__x._M_t) {}

  intv_multimap<_Key, _Tp, _Compare, _Alloc> &
  operator=(const intv_multimap<_Key, _Tp, _Compare, _Alloc> &__x) {
    _M_t = __x._M_t;
    return *this;
  }
   ...
   *  intv_multimap.  Iteration is done in ascending order according to the
   * keys.
  */
   ...
   *  in the intv_multimap.  Iteration is done in ascending order according to
   * the
   *  keys.
  */
  ...
  */
   ...
   *  pair in the intv_multimap.  Iteration is done in ascending order according
   *  to the keys.
  */
   ...
   *  the intv_multimap.  Iteration is done in descending order according to the
   *  keys.
  */
   ...
   *  pair in the intv_multimap.  Iteration is done in descending order
   * according
   *  to the keys.
  */
   ...
   *  first pair in the intv_multimap.  Iteration is done in descending order
  ...
  */
   ...
   *  before the first pair in the intv_multimap.  Iteration is done in
   * descending
  ...
  */
  ...
  void swap(intv_multimap<_Key, _Tp, _Compare, _Alloc> &__x) {
    _M_t.swap(__x._M_t);
  }

  // insert/erase
  /**
   *  @brief Inserts a std::pair into the intv_multimap.
   *  @param  x  Pair to be inserted (see std::make_pair for easy creation of
   *             pairs).
   *  @return An iterator that points to the inserted (key,value) pair.
   *
   *  This function inserts a (key, value) pair into the intv_multimap. Contrary
   *  to a std::map the intv_multimap does not rely on unique keys and thus a
   *  multiple pairs with the same key can be inserted.
  */
  iterator insert(const value_type &__x, const key_type &__y) {
    return _M_t.insert_equal(__x, __y);
  }
  ...
  */
  iterator insert(iterator __position, const value_type &__x,
                  const key_type &__y) {
    return _M_t.insert_equal(__position, __x, __y);
  }

  /**
   *  @brief A template function that attemps to insert elements from
   *         another range (possibly another intv_multimap or standard
   * container).
  ...
  */
  ...
  /**
   *  @brief Erases an element from a intv_multimap.
  ...
  */
  ...
  /**
   *  @brief Erases a [first,last) range of elements from a intv_multimap.
   *  @param  first  Iterator pointing to the start of the range to be erased.
   *  @param  last  Iterator pointing to the end of the range to be erased.
   *
   *  This function erases a sequence of elements from a intv_multimap.
  ...
  */
  ...
  /** Erases all elements in a intv_multimap.  Note that this function only
   * erases
  ...
  */
  ...
  // intv_multimap operations:

  /**
   *  @brief Tries to locate an element in a intv_multimap.
  ...
  */
  ...
  friend bool operator==(const intv_multimap<_K1, _T1, _C1, _A1> &,
                         const intv_multimap<_K1, _T1, _C1, _A1> &);
  template <class _K1, class _T1, class _C1, class _A1>
  friend bool operator<(const intv_multimap<_K1, _T1, _C1, _A1> &,
                        const intv_multimap<_K1, _T1, _C1, _A1> &);
};
...
template <class _Key, class _Tp, class _Compare, class _Alloc>
inline void swap(intv_multimap<_Key, _Tp, _Compare, _Alloc> &__x,
                 intv_multimap<_Key, _Tp, _Compare, _Alloc> &__y) {
  __x.swap(__y);
}

} // namespace std

#endif /* __GLIBCPP_INTERNAL_INTV_MULTIMAP_H */
