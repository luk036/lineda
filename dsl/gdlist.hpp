#ifndef DSL_GDLIST_HPP
#define DSL_GDLIST_HPP
...
std::ostream &operator<<(std::ostream &, const gdlist<_Node> &);
...
public:
  ...
  friend std::ostream &operator<<<>(std::ostream &, const gdlist<_Node> &);
...
private:
  ...
  gdlist(const gdlist<_Node> &);
  gdlist<_Node> &operator=(const gdlist<_Node> &);
