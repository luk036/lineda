...
void rectangle_TestCase::setUp() {
  ...
  // xxx Point<AAF>
  // lower_left_p=Point<AAF>(AAF(interval(2,5)),AAF(interval(2,5)));
...
void rectangle_TestCase::test_sum() {
  ...
  // xxx   const rectangle r1 = rectangle::random();
  // xxx   const rectangle r2 = rectangle::random();
  // xxx   const rectangle r3 = rectangle::random();
  // xxx   CPPUNIT_ASSERT (plus_ok(r1, r2, r3));
  // xxx }
}
