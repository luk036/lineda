...
for i = 1:n
    ...
    [e_sigma2_RESCF(i),e_rou_RESCF(i),t_RESCF(i),e_sigma2_MLEMVN(i),e_rou_MLEMVN(i),t_MLEMVN(i)...
        e_sigma2_MLEMVN2(i),e_rou_MLEMVN2(i),t_MLEMVN2(i)]=fun_SCE_c0104(ChipInfo,VarInfo,CorrPara,GenOpt);
end
save table8_last-5.mat
