...
%load('sample_xor2_20080118.mat');
% load('sample_xor2_20080128.mat'); % most recently used before vacation
load('sample_xor2_p18_20080220.mat');
...
figure, fnplt(st);  view(135,30); axis tight; hold on;
plot3(xWn,xWp,yTf,'wo');
xlabel('Wn \times 10^6'); ylabel('Wp \times 10^6');
zlabel('Tfall \times 10^9');
%saveas('INV_Tfall_org','pdf');
tic;
sp_fall_auto = spcvx2d_gen_H({knots_Wn,knots_Wp},...
                             [k1 k2],[xWn' xWp'],yTf);
t_cvx = toc;
tic;
[Qnew,Q,B,C] = rank_1([xWn;xWp],yTf',2000);
t_rnk = toc;
% --------------------------------------------------------
tic;
