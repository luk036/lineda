...
%load('sample_nor2_20080117.mat');
% load('sample_nor2_20080128.mat'); % most recently used before vacation
load('sample_nor2_p18_20080220.mat');
...
print -f1 -depsc 'nor2_Tfall_org.eps';
tic;
