...
%load('sample_oai211_20080127.mat');
% load('sample_oai211_20080128.mat'); % most recently used before vacation
load('sample_oai211_p18_20080220.mat'); 
...
print -f1 -depsc 'oai211_Tfall_org.eps';
tic;
...
print -f2 -depsc 'oai211_Tfall_cvx.eps';
...
print -f3 -depsc 'oai211_Tfall_rnk.eps';
...
print -f4 -depsc 'oai211_Tfall_pos.eps';
