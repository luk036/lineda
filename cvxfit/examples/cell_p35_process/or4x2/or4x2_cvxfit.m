...
% load('sample_or4x2_20080128.mat');
% load('sample_or4x2_20080127_p35u_30u.mat'); % large
% load('sample_or4x2_20080127_p4u_18u.mat');
% load('sample_or4x2_20080127_1u_15u.mat')
% load('sample_or4x2_20080127_2u_10u.mat');
% load('sample_or4x2_20080127_3u_8u.mat');  % small
%
% load('sample_or4x2_p18_20080219_p18u_10u.mat'); % large
% load('sample_or4x2_p18_20080219_p18u_5u.mat');
% load('sample_or4x2_p18_20080219_p18u_2u.mat')
% load('sample_or4x2_p18_20080219_p18u_1u.mat');
% load('sample_or4x2_p18_20080219_p18u_p5u.mat');  % small
load('sample_or4x2_p18_20080219_p18u_4u.mat');
...
print -f1 -depsc 'or4x2_Tfall_org.eps';
...
t_rnk = toc;
% --------------------------------------------------------
% mind the 1./ if fitting error is unreasonablly larger than rank-1.
tic;
posy_coef = fit_posy({xWn,xWp},1./yTf,2);
t_psy = toc;
% --------------------------------------------------------
...
for ii = 1:l,
    for jj = 1:m,
        ...
        falltime_pos(ii,jj) = 1/fposy_val({WnWn(ii,jj),WpWp(ii,jj)},posy_coef);
    end
end
figure, 
...
print -f2 -depsc 'or4x2_Tfall_cvx.eps';
...
print -f3 -depsc 'or4x2_Tfall_rnk.eps';
