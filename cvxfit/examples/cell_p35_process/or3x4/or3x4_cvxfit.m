...
%load('sample_or3x4_20080127.mat');
% load('sample_or3x4_20080128.mat'); % most recently used before vacation
load('sample_or3x4_p18_20080220.mat');
...
print -f1 -depsc 'or3x4_Tfall_org.eps';
tic;
...
print -f2 -depsc 'or3x4_Tfall_cvx.eps';
...
print -f3 -depsc 'or3x4_Tfall_rnk.eps';
...
print -f4 -depsc 'or3x4_Tfall_pos.eps';
