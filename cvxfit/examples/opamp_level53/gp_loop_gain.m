function [design, flag] = gp_loop_gain(design,SPEC, MOS3p3)
...
%           power <= SPEC.power;
%          ]; 
gm1 = c_gm1 * W1^a_gm1_W1 * I1^a_gm1_I1;
gm6 = c_gm6 * W6^a_gm6_W6 * I6^a_gm6_I6;
go1 = c_go1 * W1^a_go1_W1 * I1^a_go1_I1;
go3 = c_go3 * W3^a_go3_W3 * I1^a_go3_I1;
go6 = c_go6 * W6^a_go6_W6 * I6^a_go6_I6;
go7 = c_go7 * W7^a_go7_W7 * I7^a_go7_I7;

%Av_inv = (go1+go3)*(go6+go7)/(gm1*gm6);
...
gain_tmp = eval_gain(W1,W5,W6,W7,W8,I8)
