function [design, flag] = gp_loop_bdw(design,SPEC, MOS3p3)
...
global c_go7 a_go7_W7 a_go7_I6
%
...
gm6 = c_gm6 * W6^a_gm6_W6 * I7^a_gm6_I6;
...
%% solve the GP
[bdw_max, solution, status] = gpsolve(bdw, constr, 'max')
